...
`Mar 12, 2024`, `12-Mar-24`. The `published\_at` column we store is our own
...
`estimated\_value` column is our parse of it and is usually right.
...
so `published\_at` ordering does not tell you which copy came first.
